...
class ItemManager
{
	...
	ItemManager()
	{
		...
		addItem(WOOD_BLOCK, "Wood block", "A block of wood", 255, @Sprite(@TextureRegion(@Texture(":/sprites/tiles/tree_tile.png"), 1.0f/21.0f * 16, 0.0f, 1.0f/21.0f * (16+1), 1.0f)));
		addItem(STICK, "Stick", "A stick", 255, @Sprite(@Texture(":/sprites/items/stick.png")));
