// Source: https://code.google.com/p/battlestar-tux/source/browse/procedural/simplexnoise.cpp
...
class Simplex2D
{
	...
	private float rawNoise(float x, float y)
	{	
	...
	float dot(const array<int> g, const float x, const float y)
	{
		return g[0]*x + g[1]*y;
	}
}
...
class Simplex3D
{
	...
	private float rawNoise(const float x, const float y, const float z)
	{	
		// Noise contributions from the three corners
		float n0, n1, n2, n3;
	...
	float dot(const array<int> g, const float x, const float y, const float z)
	{
